...
const TextStyle kCardTitleStyle =
    TextStyle(color: kTextColor, fontSize: 18, fontWeight: FontWeight.bold);
const TextStyle kCardSubtitleStyle = TextStyle(color: kTextColor, fontSize: 14);
const TextStyle kSectionHeaderStyle =
